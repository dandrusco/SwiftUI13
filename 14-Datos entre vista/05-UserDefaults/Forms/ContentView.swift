...
//1. Ahora en la ContentView deberemos aplicar los cambios de acuerdo al filtrado
import SwiftUI
...
struct ContentView: View {
    ...
    //2. Tambien deberemos crear una variable de tipo SettingsFactory
    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $showSettingsView){
                //3. cambiaremos esta linea "SettingsView(settings: SettingsFactory())", ya que ahora le pasaremos la variable setting creada en el paso anterior
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        //4. Y ahora cambiarems la ContentView() por que le deberemos pasar el setting de la SettingsFactory()
        ContentView(settings: SettingsFactory())
        //5. Ahora se nos sigue quejando el compilador, deberemos ir al archivo FormsApp
    }
}
