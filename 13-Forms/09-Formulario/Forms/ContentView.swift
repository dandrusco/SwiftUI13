...
//1. Partiremos del ejemplo 07-Action Sheet para continuar ya que el 08 no estoy seguro si funciara bien
//2. Crearemos un nuevo fichero llamado SettingsView de tipo SwiftUIView
import SwiftUI
