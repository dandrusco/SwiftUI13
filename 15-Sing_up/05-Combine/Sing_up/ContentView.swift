...
//1. Para poder comenzar a registraros deveremos crear un modelo de vista
//2. Para ello crearemos un nuevo archivo de Swift File el cual llamaremos RegistrationViewModel
import SwiftUI
